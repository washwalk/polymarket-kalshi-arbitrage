            ...
            <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 group">
                 ...
                 <nav className="flex gap-6 text-sm font-medium items-center">
                     <Link href="/arb" className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors">
                         Arbitrage
                     </Link>
                     <Link href="/whales" className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors">
                         Whales
                     </Link>
                     <Link href="/burner" className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors">
                         Burner
                     </Link>
